                        ...
                        child: isContainerVisible
                            ? SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 300,top: 18.0),
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: treatmentEditingController,
                                      keyboardType: TextInputType.multiline,
                                      maxLines: null,
                                      decoration: InputDecoration(
                                        hintText: 'Treatment',
                                  ...
                                  children: [
                                    ...
                                    TextField(
                                      ...
                                      onChanged: (query) async {
                                        ...
                                        print("consu$storedConsultationID");
                                          ...
                                          Container(
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                } else if (index < selectedMedications.length + medicationSuggestions.length) {
                                                    ...
                                                    onTap: () {
                                                      setState(() {
                                                        selectedMedications.add({
                                                          'MedID' : medicationSuggestions[suggestionIndex]['MedID'],
                                                        ...
                                                        suggestion['MedID'] == medicationSuggestions[suggestionIndex]['MedID']
                                                                  ...
                                                                  Container(
                                                                    child: Padding(
                                                                      ...
                                                                      child: TextField(
                                                                        ...
                                                                        decoration: InputDecoration(
                                                                          hintText:
                                                                          'Enter additional information for ${selectedMedications[index]['MedGeneral']}(${selectedMedications[index]['Dosage'] ?? ''})',
                                                                        ),
                                                                        // Handle the onChanged or onSubmitted event based on your needs
                                                                      ),
                                                                    ),
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            child: Column(
                                              children: [
                                                customText("Consultation Fees"),
                                                TextField(
                                                  controller: rmEditingController,
                                                  decoration: InputDecoration(
                                                    hintText: 'Enter RM',
                                                  ),
                                          ...
                                          Expanded(
                                            child: TextField(
                                              controller: centsEditingController,
                                              decoration: InputDecoration(
...
// Add this GestureDetector to toggle isContainerVisible using Icons.minimize and Icons.maximize
  ...
  Widget customText1(String text,) {
    return Text(
      text,
      style: TextStyle(fontSize: 20,
          fontWeight: FontWeight.bold),
  ...
  Future<void> insertConsultationInformation(int consultationID, String symptom, String treatment, String combinedFees) async {
    final String url = 'http://${MyApp.ipAddress}/teleclinic/insertConsultationInformation.php?consultationID=$consultationID';
  ...
  Future<void> insertMedicationDetails(
      int consultationID,
      List<Map<String, dynamic>> selectedMedications
      ) async {
    final String url = 'http://${MyApp
        .ipAddress}/teleclinic/insertMedicationDetails.php';
